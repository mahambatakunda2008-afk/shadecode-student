...
Build a versioned benchmark set and compare calibrated weights against the baseline on a held-out set. Only if the improvement survives the holdout should calibration become part of a controlled offline experimentation workflow.
