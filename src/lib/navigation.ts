import { House, Timer, ListChecks, BookOpen, BarChart3, Trophy, BrainCircuit, CalendarDays, PlaySquare, Settings, Award, GraduationCap, Route, FileText, UploadCloud, ClipboardCheck, Tags, Globe, MessageSquare, Settings2, Share2, BriefcaseBusiness, FolderKanban, LibraryBig, Code2, Smartphone } from "lucide-react";
...
export const NAV_ITEMS: Record<string, NavItem> = {
 dashboard:{href:"/dashboard",label:"Home",icon:House}, focus:{href:"/focus",label:"Focus",icon:Timer}, tasks:{href:"/tasks",label:"Tasks",icon:ListChecks}, exams:{href:"/exams",label:"Assessments",icon:BookOpen}, examHub:{href:"/exam-hub",label:"Exam Hub",icon:FileText}, examSim:{href:"/exam-sim",label:"Exam Sim",icon:PlaySquare}, learn:{href:"/learn",label:"Learn",icon:BookOpen}, compLab:{href:"/comp-lab",label:"Comp Lab",icon:Code2}, curriculum:{href:"/curriculum",label:"Courses",icon:BookOpen}, workmate:{href:"/workmate",label:"Workmate",icon:BriefcaseBusiness}, projects:{href:"/projects",label:"Projects",icon:FolderKanban}, studyspace:{href:"/studyspace",label:"StudySpace",icon:LibraryBig}, timetable:{href:"/timetable",label:"Timetable",icon:CalendarDays}, studyPlan:{href:"/study-plan",label:"Study Plan",icon:Route}, analytics:{href:"/analytics",label:"Progress",icon:BarChart3}, leaderboard:{href:"/leaderboard",label:"Leaderboard",icon:Trophy}, cortex:{href:"/insights/history",label:"Cortex",icon:BrainCircuit}, study:{href:"/study",label:"Study Session",icon:GraduationCap}, achievements:{href:"/achievements",label:"Achievements",icon:Award}, share:{href:"/share",label:"Share",icon:Share2}, whatsapp:{href:"/whatsapp",label:"WhatsApp",icon:Smartphone}, settings:{href:"/settings",label:"Settings",icon:Settings},
