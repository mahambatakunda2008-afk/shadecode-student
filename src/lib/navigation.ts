...
export const NAV_ITEMS: Record<string, NavItem> = {
  ...
  tasks: { href: "/tasks", label: "Tasks", icon: ListChecks, feature: "tasks" },
  exams: { href: "/exams", label: "Assessments", icon: ClipboardCheck, feature: "assessments" },
  ...
  curriculum: { href: "/curriculum", label: "Courses", icon: BookOpen, feature: "courses" },
  workmate: { href: "/workmate", label: "Workmate", icon: BriefcaseBusiness, feature: "workmate" },
  projects: { href: "/projects", label: "Projects", icon: FolderKanban, feature: "projects" },
  studyspace: { href: "/studyspace", label: "StudySpace", icon: LibraryBig, feature: "studyspace" },
  timetable: { href: "/timetable", label: "Timetable", icon: CalendarDays, feature: "timetable" },
  studyPlan: { href: "/study-plan", label: "Study Plan", icon: Route, feature: "study-plan" },
  analytics: { href: "/analytics", label: "Progress", icon: BarChart3, feature: "progress" },
  ...
  study: { href: "/study", label: "Study Session", icon: GraduationCap, feature: "study" },
  achievements: { href: "/achievements", label: "Achievements", icon: Award, feature: "achievements" },
  share: { href: "/share", label: "Share", icon: Share2, feature: "share" },
  whatsapp: { href: "/whatsapp", label: "WhatsApp", icon: Smartphone, feature: "whatsapp" },
  profile: { href: "/settings", label: "Profile", icon: UserRound, feature: "profile" },
  virtualLab: { href: "/virtual-lab", label: "Virtual Lab", icon: FlaskConical, feature: "virtual-lab" },
