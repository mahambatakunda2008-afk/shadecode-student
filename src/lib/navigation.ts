...
export const NAV_ITEMS: Record<string, NavItem> = {
 dashboard:{href:"/dashboard",label:"Home",icon:LayoutDashboard}, focus:{href:"/focus",label:"Focus",icon:Timer}, tasks:{href:"/tasks",label:"Tasks",icon:CheckSquare}, exams:{href:"/exams",label:"Assessments",icon:BookOpen}, examHub:{href:"/exam-hub",label:"Exam Hub",icon:FileText}, examSim:{href:"/exam-sim",label:"Exam Sim",icon:Gamepad2}, learn:{href:"/learn",label:"Learn",icon:Brain}, codeLab:{href:"/code-lab",label:"Code Lab",icon:Code2}, curriculum:{href:"/curriculum",label:"Courses",icon:BookOpen}, workmate:{href:"/workmate",label:"Workmate",icon:BriefcaseBusiness}, projects:{href:"/projects",label:"Projects",icon:FolderKanban}, studyspace:{href:"/studyspace",label:"StudySpace",icon:Library}, timetable:{href:"/timetable",label:"Timetable",icon:Calendar}, studyPlan:{href:"/study-plan",label:"Study Plan",icon:Route}, analytics:{href:"/analytics",label:"Progress",icon:BarChart3}, leaderboard:{href:"/leaderboard",label:"Leaderboard",icon:Trophy}, cortex:{href:"/insights/history",label:"Cortex",icon:BrainCircuit}, study:{href:"/study",label:"Study Session",icon:GraduationCap}, achievements:{href:"/achievements",label:"Achievements",icon:Award}, share:{href:"/share",label:"Share",icon:Share2}, settings:{href:"/settings",label:"Settings",icon:Settings},
...
export const SIDEBAR_GROUPS:NavGroup[]=[{group:"Core",items:[NAV_ITEMS.dashboard,NAV_ITEMS.focus,NAV_ITEMS.study,NAV_ITEMS.timetable,NAV_ITEMS.studyPlan]},{group:"Practice",items:[NAV_ITEMS.codeLab,NAV_ITEMS.examHub,NAV_ITEMS.tasks,NAV_ITEMS.exams,NAV_ITEMS.examSim]},{group:"Tools",items:[NAV_ITEMS.learn,NAV_ITEMS.curriculum,NAV_ITEMS.projects,NAV_ITEMS.workmate,NAV_ITEMS.studyspace,NAV_ITEMS.cortex,NAV_ITEMS.share]},{group:"Progress",items:[NAV_ITEMS.analytics,NAV_ITEMS.leaderboard,NAV_ITEMS.achievements]}];
export const BOTTOM_PRIMARY:NavItem[]=[NAV_ITEMS.dashboard,NAV_ITEMS.learn,NAV_ITEMS.codeLab,NAV_ITEMS.tasks,NAV_ITEMS.focus];
