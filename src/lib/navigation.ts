...
export const BOTTOM_MORE:NavItem[]=[NAV_ITEMS.timetable,NAV_ITEMS.studyPlan,NAV_ITEMS.study,NAV_ITEMS.exams,NAV_ITEMS.examSim,NAV_ITEMS.examHub,NAV_ITEMS.curriculum,NAV_ITEMS.workmate,NAV_ITEMS.studyspace,NAV_ITEMS.analytics,NAV_ITEMS.leaderboard,NAV_ITEMS.achievements,NAV_ITEMS.cortex,NAV_ITEMS.share,NAV_ITEMS.settings];
