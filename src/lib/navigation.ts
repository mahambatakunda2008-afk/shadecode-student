import { LayoutDashboard, Timer, CheckSquare, BookOpen, Brain, BarChart3, Trophy, BrainCircuit, Calendar, Gamepad2, Settings, Award, GraduationCap, Route, FileText, UploadCloud, ClipboardCheck, Tags, Globe, MessageSquare, Settings2, Share2, BriefcaseBusiness, FolderKanban, Compass, Sparkles, Library, Target, Users, BadgeCheck } from "lucide-react";
...
export const NAV_ITEMS = {
 ...
 exams:{href:"/exams",label:"Assessments",icon:BookOpen},
 ...
 discovery:{href:"/discovery",label:"Discovery",icon:Compass},
...
/*
 * Shadecode has three learner experiences, not eight separate navigation systems:
 * 1. FOUNDATION: ECD + Primary, discovery-first and child-friendly.
 * 2. SCHOOL: Lower Secondary + Upper Secondary + A-Level, subject/exam-first.
 * 3. BEYOND SCHOOL: University + TVET + Professional, programme/work/portfolio-first.
 *
 * Academic stages still control content, terminology and capabilities inside each
 * experience. Navigation is intentionally a first-class experience decision.
 */
export function getExperienceNavGroups(experience: AcademicExperience): NavGroup[] {
  ...
  const beyond: NavGroup[] = [
    { group:"Workspace", items:[NAV_ITEMS.dashboard, NAV_ITEMS.curriculum, NAV_ITEMS.learn, NAV_ITEMS.studyspace ?? NAV_ITEMS.study] },
...
export const SIDEBAR_GROUPS:NavGroup[]=[
  {group:"Core",items:[NAV_ITEMS.dashboard,NAV_ITEMS.discovery,NAV_ITEMS.focus,NAV_ITEMS.study,NAV_ITEMS.timetable,NAV_ITEMS.studyPlan]},
  {group:"Practice",items:[NAV_ITEMS.examHub,NAV_ITEMS.tasks,NAV_ITEMS.exams,NAV_ITEMS.examSim]},
  {group:"Tools",items:[NAV_ITEMS.learn,NAV_ITEMS.curriculum,NAV_ITEMS.projects,NAV_ITEMS.workmate]},
