...
describe("post-secondary academic helpers", () => {
  ...
  it("orders open assessments by due date", () => {
    const assessments: AcademicAssessment[] = [
      { id: "late", courseId: "cs", title: "Exam", type: "exam", dueAt: "2026-09-10T00:00:00.000Z", completed: false },
      { id: "soon", courseId: "cs", title: "Assignment", type: "assignment", dueAt: "2026-08-20T00:00:00.000Z", completed: false },
      { id: "done", courseId: "cs", title: "Done", type: "test", dueAt: "2026-08-18T00:00:00.000Z", completed: true },
    ];
  ...
  it("weights nearer assessments more heavily", () => {
    const base: AcademicAssessment = { id: "a", courseId: "cs", title: "Assignment", type: "assignment", completed: false, weight: 20, dueAt: "2026-08-18T00:00:00.000Z" };
    const soon = assessmentPressure(base, new Date("2026-08-17T00:00:00.000Z"));
