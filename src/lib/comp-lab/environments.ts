...
/**
 * Comp Lab is Shadecode Student's computing environment.
 * It models the real environments students encounter across school,
 * university/polytechnic and professional development.
