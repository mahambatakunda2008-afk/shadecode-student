...
export const CAMBRIDGE_0478_2026_2028_REQUIRED_KINDS: CurriculumKnowledgeKind[] = [
  ...
  "terminology", "constraint", "guidance", "resource",
];

export const CAMBRIDGE_0478_2026_2028_TOPICS = [
  "data-representation", "data-transmission", "hardware", "software", "internet-and-its-uses",
  "automated-and-emerging-technologies", "algorithm-design-and-problem-solving", "programming",
  "databases", "boolean-logic",
] as const;

export const CAMBRIDGE_0478_2026_2028_ASSESSMENT = {
  paper1: { title: "Computer Systems", marks: 75, durationMinutes: 105, weightingPercent: 50, topics: ["1-6"], calculators: false, externallyAssessed: true },
  paper2: { title: "Algorithms, Programming and Logic", marks: 75, durationMinutes: 105, weightingPercent: 50, topics: ["7-10"], calculators: false, externallyAssessed: true },
