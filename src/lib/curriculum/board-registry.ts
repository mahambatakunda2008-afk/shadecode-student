...
export const CURRICULUM_BOARDS: CurriculumBoardDefinition[] = [
  {
    ...
    support: "verified",
    sourceOfTruth: "Published ZIMSEC syllabus documents and syllabus resource pages",
  },
  {
    boardId: "cambridge",
    name: "Cambridge International Education",
    qualifications: ["cambridge-igcse", "cambridge-as-a-level"],
    levels: ["primary", "lower_secondary", "igcse", "as", "a_level"],
    support: "available",
