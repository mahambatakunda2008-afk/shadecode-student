...
export type RuntimeProviderId = "browser-javascript" | "typescript-transpiler" | "pseudocode-interpreter" | "shade-interpreter" | "dotnet" | "python" | "jvm" | "native-c" | "native-cpp" | "sql" | "generic-native";
  ...
  const message = provider === "typescript-transpiler"
    ...
    : provider === "pseudocode-interpreter"
      ...
      : provider === "shade-interpreter"
        ? "The Shade interpreter is unavailable."
        : provider === "dotnet"
