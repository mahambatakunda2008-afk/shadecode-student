...
export const PLATFORM_CAPABILITIES: CapabilityContract[] = [
  ...
  { id: "runtime.office", version: 1, label: "Office integration", description: "Create and inspect Office-compatible artifacts such as spreadsheets and documents.", platforms: ["desktop", "native", "edge", "cloud"], availability: "artifact", permissions: ["project.storage"], privacyClass: "private", networkRequired: false },
