...
const base: LearnerContext = { stage: "A-Level", board: "Cambridge", qualification: "AS & A Level", syllabusCode: "9702", syllabusYear: "2027", subjects: ["Physics"], onboardingComplete: true };
