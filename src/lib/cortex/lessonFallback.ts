...
const FALLBACK_LESSONS: Record<string, FallbackLesson> = {
  ...
  "computer science|binary number systems": {
    ...
    blocks: [
      ...
      { type: "example", title: "Worked conversion: binary to denary", content: "Convert 1011 0110 to denary. Write the place values above each bit: 128 64 32 16 8 4 2 1. The bit is 1 under 128, 32, 16, 4, and 2. Add those place values: 128 + 32 + 16 + 4 + 2 = 182. So 1011 0110 in binary equals 182 in denary." },
      { type: "example", title: "Worked conversion: denary to binary", content: "Convert 91 to binary. Find the largest place value that fits: 64 fits (91 − 64 = 27). Next, 32 does not fit into 27, so that column is 0. 16 fits (27 − 16 = 11). 8 fits (11 − 8 = 3). 4 does not fit into 3, so 0. 2 fits (3 − 2 = 1). 1 fits (1 − 1 = 0). Reading the columns used: 64,32,16,8,4,2,1 gives 1 0 1 1 0 1 1, so 91 = 0101 1011 as an 8-bit number." },
  ...
  "physics|newtons laws of motion": {
    ...
    blocks: [
      ...
      { type: "example", title: "Worked example: finding acceleration", content: "A resultant force of 40 N acts on a 8 kg trolley. Find its acceleration. Rearrange F = ma to a = F/m = 40/8 = 5 m/s². The trolley accelerates at 5 m/s² in the direction of the resultant force." },
      ...
      { type: "example", title: "Worked example: identifying pairs", content: "A book rests on a table. The book pushes down on the table (weight, due to gravity pulling the book down); the table pushes up on the book (normal contact force) with equal magnitude. These two forces are a genuine Newton's-third-law pair because they act on different objects (book on table; table on book) and are the same type of interaction reversed." },
