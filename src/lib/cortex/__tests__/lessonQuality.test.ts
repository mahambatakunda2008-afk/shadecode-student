...
const strongLesson = [
  ...
  { type: "example", title: "Worked example", content: "A spring has stiffness 250 N m^-1 and is extended by 0.040 m. Step 1: write F = kx. Step 2: substitute F = 250 x 0.040. Step 3: calculate F = 10 N. Check that the unit is newtons. The value is reasonable because a stiffness of 250 N m^-1 means each metre of extension would require 250 N in the proportional region, so 0.040 m requires one twenty-fifth of that force." },
