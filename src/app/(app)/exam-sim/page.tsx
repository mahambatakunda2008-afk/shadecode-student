...
export default function ExamSimulationPage() {
  ...
  return <ExamWorkspace initialSubject={subject} initialTopic={topic} initialDifficulty={difficulty} initialQuestionCount={[5, 10, 15, 20].includes(count) ? count : 10} onExit={() => router.push("/dashboard")} />;
}
