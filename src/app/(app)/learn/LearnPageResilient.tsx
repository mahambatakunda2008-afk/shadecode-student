...
export default function LearnPageResilient() {
  ...
  const generating = generationJob?.status === "queued" || generationJob?.status === "warming" || generationJob?.status === "generating";
