...
export interface StudyTopic { id: string; subject: string; topic: string; created_at: string; }
...
export interface DiagramBlock { kind: DiagramKind; title?: string; description?: string; nodes?: Array<{ id: string; label: string; x?: number; y?: number; shape?: "box" | "circle" | "point" }>; edges?: Array<{ from: string; to: string; label?: string; directed?: boolean }>; labels?: Array<{ text: string; x?: number; y?: number }>; data?: Array<{ x: number; y: number; label?: string }>; equations?: string[]; }
export interface LessonBlock { type: string; title?: string; content: string; formula?: string; diagram?: DiagramBlock; example?: { question: string; answer: string }; options?: string[]; answer?: string; }
export interface LessonResponse { blocks: LessonBlock[]; xpReward: number; difficulty: "guided" | "standard" | "challenge"; }
