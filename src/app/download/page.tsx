    ...
    <main className="min-h-screen bg-[#0B0D12] px-5 py-10 text-white sm:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3" aria-label="Download options">
          ...
          <PlatformCard icon="💻" title="Desktop PWA" description="On supported desktop browsers, install Shadecode Student from the browser's install button for a standalone app window." action="Open desktop app" href={WEB_URL} external secondary="Use the browser install icon in the address bar." />
        </section>
