...
- Every block must be at least 30 characters and contain specific teaching value.
...
Format objective/mistake with "- " lines. Format practice with "1. ", "2. ", "3. " lines. Use plain student-facing language. Use only these block types where possible: objective, prior, concept, definition, formula, example, checkpoint, comparison, misconception, exam, application, mistake, summary, practice, tip.
