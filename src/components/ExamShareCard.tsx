...
const DIFFICULTY_BADGE: Record<string, string> = {
  'O-Level': 'bg-blue-500/15 text-blue-300 border-blue-500/30', 'Ordinary': 'bg-blue-500/15 text-blue-300 border-blue-500/30', 'A-Level': 'bg-purple-500/15 text-purple-300 border-purple-500/30', 'Advanced': 'bg-purple-500/15 text-purple-300 border-purple-500/30', 'University': 'bg-rose-500/15 text-rose-300 border-rose-500/30', 'Challenge': 'bg-rose-500/15 text-rose-300 border-rose-500/30',
}
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="relative rounded-2xl border border-[var(--card-border)] bg-[var(--card)] overflow-hidden shadow-2xl">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-[var(--card-border)]"><div className="flex items-center justify-between"><span className="text-xs font-semibold tracking-widest text-indigo-400 uppercase">◈ Shadecode Student</span><span className={cn('text-xs font-medium px-2.5 py-1 rounded-full border', diffBadge)}>{result.difficulty}</span></div></div>
