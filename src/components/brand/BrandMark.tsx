...
export function BrandMark({ title = "Shadecode Student", className, ...props }: BrandMarkProps) {
  const gradientId = `shadecode-brand-gradient-${useId().replace(/:/g, "")}`;
  ...
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id={gradientId} x1="72" y1="30" x2="478" y2="556" gradientUnits="userSpaceOnUse">
      ...
      <g fill={`url(#${gradientId})`} transform="translate(25.5 10.5)">
