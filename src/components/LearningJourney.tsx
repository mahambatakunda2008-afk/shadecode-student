...
export default function LearningJourney({ initialState = null }: Props) {
  ...
  if (loading) return (
    <div style={card}>
      <div style={{ height: 14, width: "40%", borderRadius: 6, background: "rgba(255,255,255,0.06)", marginBottom: 16 }} />
      ...
      {[0,1,2,3].map(i => (
        <div key={i} style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 14 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ height: 11, width: "70%", borderRadius: 4, background: "rgba(255,255,255,0.06)", marginBottom: 5 }} />
  ...
  return (
    <div style={card}>
      ...
      {/* ── Progress bar ── */}
      <div style={{ height: 5, borderRadius: 999, background: "rgba(255,255,255,0.06)", overflow: "hidden", marginBottom: 20 }}>
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 18 }}>
        {milestones.map(m => {
          ...
          return (
            <div key={m} style={{ flex: 1, textAlign: "center", padding: "5px 0", borderRadius: 8, background: reached ? "rgba(16,185,129,0.12)" : "rgba(255,255,255,0.03)", border: `1px solid ${reached ? "rgba(16,185,129,0.25)" : "rgba(255,255,255,0.06)"}` }}>
              <p style={{ fontSize: 10, fontWeight: 700, margin: 0, color: reached ? "#6ee7b7" : "#334155" }}>{m}%</p>
            </div>
          );
        })}
      </div>
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          {lessons.length === 0 && (
            <p style={{ fontSize: 12, color: "#475569", paddingLeft: 36 }}>No lessons in curriculum yet.</p>
          )}
          ...
          {visibleLessons.map((lesson, i) => {
            ...
            let dotContent: React.ReactNode = <Circle size={8} color="#334155" />;
            ...
            if (isCompleted) {
              ...
              dotBg     = "rgba(255,255,255,0.03)";
              dotBorder = "rgba(255,255,255,0.06)";
              dotContent = <Lock size={9} color="#1e293b" />;
            }
            ...
            else if (isLocked)     { statusLabel = "Locked";       statusColor = "#1e293b"; }
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: 12, fontWeight: 600, color: isCompleted ? "#64748b" : isCurrent ? "#f1f5f9" : "#94a3b8", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {lesson.title}
                  </p>
        ...
        {hasMore && (
          <button
            ...
            style={{ marginTop: 12, width: "100%", padding: "7px 0", borderRadius: 10, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", fontSize: 11, fontWeight: 600, color: "#475569", cursor: "pointer" }}
          >
