  ...
  return (
    <section className={className} aria-label="Study canvas">
      ...
      <div className="overflow-hidden rounded-xl touch-none">
        <CanvasViewportControls value={view} onChange={setView} className="origin-top-left">
          <div data-pan="true" style={{ transform: `translate(${view.offsetX}px, ${view.offsetY}px) scale(${view.zoom})`, transformOrigin: "0 0" }}>
