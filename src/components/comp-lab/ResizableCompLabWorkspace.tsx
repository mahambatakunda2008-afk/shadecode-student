  ...
  return (
    ...
    >
      ...
      <div
        ...
        onKeyDown={(event) => {
          if (event.key === "ArrowLeft") adjust("left", -20);
          if (event.key === "ArrowRight") adjust("left", 20);
          if (event.key === "Enter" || event.key === " ") toggle("left");
          if (event.key === "Home") setSizes((current) => ({ ...current, left: LIMITS.left[0] }));
          if (event.key === "End") setSizes((current) => ({ ...current, left: LIMITS.left[1] }));
        }}
      />
      <div
        role="separator"
        ...
        onKeyDown={(event) => {
          if (event.key === "ArrowLeft") adjust("right", 20);
          if (event.key === "ArrowRight") adjust("right", -20);
          if (event.key === "Enter" || event.key === " ") toggle("right");
          if (event.key === "Home") setSizes((current) => ({ ...current, right: LIMITS.right[0] }));
          if (event.key === "End") setSizes((current) => ({ ...current, right: LIMITS.right[1] }));
        }}
      />
      <div
        role="separator"
        ...
        onKeyDown={(event) => {
          if (event.key === "ArrowUp") adjust("bottom", 20);
          if (event.key === "ArrowDown") adjust("bottom", -20);
          if (event.key === "Enter" || event.key === " ") toggle("bottom");
          if (event.key === "Home") setSizes((current) => ({ ...current, bottom: LIMITS.bottom[0] }));
          if (event.key === "End") setSizes((current) => ({ ...current, bottom: LIMITS.bottom[1] }));
        }}
      />
