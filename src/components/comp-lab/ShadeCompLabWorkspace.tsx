...
export default function ShadeCompLabWorkspace() {
  ...
  const ir = result?.metadata?.ir as { instructions?: unknown[] } | undefined;
  ...
  function reset() { setCode(STARTER); setResult(null); }
