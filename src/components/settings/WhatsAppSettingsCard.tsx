...
export function WhatsAppSettingsCard() {
  ...
  const generateCode = async () => {
    ...
    try {
      ...
      setCode(payload.code); setExpiresAt(payload.expiresAt ?? null);
    } catch (err) { setError(err instanceof Error ? err.message : "Couldn’t generate a WhatsApp link code."); }
  ...
  const copyCode = async () => {
    ...
    catch { setError("Couldn’t copy the code. You can enter it manually in WhatsApp."); }
  };
