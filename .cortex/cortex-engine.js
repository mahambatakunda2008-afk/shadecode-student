...
function validateDecision(decision) {
  ...
  if (!Array.isArray(decision.improvements) || decision.improvements.length !== MAX_IMPROVEMENTS) throw new Error(`Cortex must produce exactly ${MAX_IMPROVEMENTS} improvement per cycle`);
